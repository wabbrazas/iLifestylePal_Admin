...
<head>
    ...
    <title>iLifestylePal - User Friends</title>
...
<body>
        ...
        <div id="content">
            ...
            <div style="margin-top: 10px;" class="card">
                <div class="card-body">
                    ...
                    <br><br>
                    <h3>User Friends</h3>
                    <h6 id="h6_uid">Showing UID: Friends List</h6><br>
    ...
    <script type="module">
        ...
        h6_uid.innerHTML = "Showing UID: " + uid + " Friends List";
        ...
        function GetAllUserFriends() {
            ...
            onValue(UsersRef,(snapshot)=>{
                ...
                snapshot.forEach(childSnapshot => {
                    ...
                    if (snapshot.child(uid).child("Friends").hasChild(uid_key)) {
