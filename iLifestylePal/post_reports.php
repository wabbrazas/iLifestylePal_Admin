...
<head>
    ...
    <title>iLifestylePal - Post Reports</title>
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div style="margin-top: 10px;" class="card">
                <div class="card-body">
                    <button id="btn_posts" class="btn btn-success"><i class="fa-solid fa-list"></i> Posts</button>
                    <button id="btn_reports" class="btn btn-success"><i class="fa-solid fa-circle-exclamation"></i> Reports</button>
                    <br><br>
                    <h3>Post Reports</h3><br>
    ...
    <div id="reportsModal" class="modal">
		<div class="modal-content">
            ...
            <div class="row">
                <div class="col-md-6">
                    <button id="del_report" style="margin-top: 30px; width: 100%;" class="btn btn-success">Delete Report</button>       
                </div>
                <div class="col-md-6">
                    <button id="del_post" style="margin-top: 30px; width: 100%;" class="btn btn-danger">Delete Post</button>       
                </div>
            </div>
		</div>
	</div>
    ...
    <script type="module">
        ...
        const btn_del_report = document.getElementById("del_report");
        btn_del_report.addEventListener("click", () => {
            let post_id = document.getElementById('post_id').value;
            let report_uid = document.getElementById('report_uid').value;

            var confirmResult = confirm("Do you want to proceed in deleting this report?");
            if (confirmResult) {
                const reportRef = ref(db, "Reports/Posts/" + post_id + "/" + report_uid);
                remove(reportRef)
                .then(() => {
        ...
        function PageRefresh() {
            window.location.href = 'post_reports.php';
        }

        const btn_posts = document.getElementById("btn_posts");
        btn_posts.addEventListener("click", () => {
            window.location.href = 'lifestyle_posts.php';
        });

        const btn_reports = document.getElementById("btn_reports");
