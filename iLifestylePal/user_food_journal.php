...
<head>
    ...
    <title>iLifestylePal - User Food Journal</title>
...
<body>
        ...
        <div id="content">
            ...
            <div style="margin-top: 10px;" class="card">
                <div class="card-body">
                    ...
                    <br><br>
                    <h3>User Food Journal</h3>
                    <h6 id="h6_uid">Showing UID: Food Journal</h6><br>
    ...
    <script type="module">
        ...
        h6_uid.innerHTML = "Showing UID: " + uid + " Food Journal";
        ...
        function GetFoodJournal() {
            ...
            onValue(foodJournalRef, (snapshot) => {
                const journals = [];
        ...
        function DisplayToTable(journals) {
            ...
            journals.forEach(element => {
                DisplayItemToTable(element.date, element.meal, element.foodName, element.serving, element.calorie);
            });
        }

        function DisplayItemToTable(date, meal, foodName, serving, calorie) {
            ...
            td2.innerHTML = date;
            td3.innerHTML = meal;            
            td4.innerHTML = foodName;
            td5.innerHTML = serving + " servings";
