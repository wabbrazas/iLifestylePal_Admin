...
<head>
    ...
    <title>iLifestylePal - List of Activities</title>
...
<body>
            ...
            <div style="margin-top: 10px;" class="card">
                <div class="card-body">
                    <button class="btn btn-success">
                        <a href="daily_activity.php">Daily Activity</a>
                    </button>
    ...
    <div id="myModal" class="modal">
		<div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button id="saveActivity" style="margin-top: 30px; width: 100%;" class="btn btn-success">Save Activity</button>       
                </div>
            </div>
		</div>
	</div>
    ...
    <script>
		function openModal() {
            ...
            document.getElementById('saveActivity').innerHTML = "Add Activity";
		}
    ...
    <script type="module">
        ...
        function GetAllActivitiesData() {
            const ActivitiesRef = ref(db, "Maintenance/Daily Activity");
        ...
        saveButton.addEventListener('click', () => {
            ...
            let actMET = document.getElementById('act_met').value;

            if (actName !== '' && actName !== null && actMET !== '' && actMET !== null) {
                const ActivitiesRef = ref(db, "Maintenance/Daily Activity/"+actName);
                const dataToInsert = {
        ...
        $('#tbody_activities').on('click', 'button#editActivity', (event) => {
            ...
            document.getElementById('saveActivity').innerHTML = "Update Activity";
        });
        ...
        $('#tbody_activities').on('click', 'button#deleteActivity', (event) => {
            ...
            if (confirmResult) {
                const ActivitiesRef = ref(db, "Maintenance/Daily Activity/"+cellData);
