...
<head>
    ...
    <title>iLifestylePal - Health Conditions</title>
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div style="margin-top: 10px;" class="card">
                <div class="card-body">
                    <button onclick="openModal()" class="btn btn-success"><i class="fa-solid fa-plus"></i> Add Health Condition</button>
                    <br><br>
    ...
    <script type="module">
        ...
        save_hc.addEventListener('click', () => {
            let hc_name = document.getElementById('hc_name').value;

            if (hc_name !== '' && hc_name !== null) {
        ...
        update_hc.addEventListener('click', () => {
            let hc_name = document.getElementById('hc_name').value;
            let hc_name2 = document.getElementById('hc_name2').value;
        ...
        function PageRefresh() {
            window.location.href = 'health_conditions.php';
        }
